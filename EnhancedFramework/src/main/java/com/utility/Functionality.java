...
public class Functionality {
	...
	public void Open_Browser(String arg1, String arg2,String arg3) {
		...
		String chromePath = "C:\\Users\\m1047245\\Downloads\\chromedriver.exe";
	...
	public void Click(String vclick, String arg2,String arg3) {
		...
		if(vclick.equalsIgnoreCase("click_login")) {
			...
			logger.log(LogStatus.INFO,
					"All ScreenShots Taken" + "   " + "<a href = 'C:\\Users\\M1047245\\Pictures\\scrshots'>Files</a>");
			report.endTest(logger);
			report.flush(); 
	...
	public void screenshot(String arg1, String arg2,String arg3) {
		...
		File dest = new File("C:\\Users\\M1047245\\Pictures\\Screenshots\\team.jpg");
		try {
	...
	public void quit(String arg1, String arg2,String arg3) {
		...
		System.out.println("Successful end to end flow");
	...
	public void takeScreenShot(String scrName) {
		...
		TakesScreenshot scrShot = ((TakesScreenshot)driver);
		File src = scrShot.getScreenshotAs(OutputType.FILE);
		String screenshotName = "C:\\Users\\M1047245\\Pictures\\scrshots\\";
